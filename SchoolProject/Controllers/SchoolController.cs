...
public class SchoolController : Controller {
	...
	public IActionResult Delete(int id) {
		Result<SchoolDTO> getResult = _schoolService.GetById(id);

		Result<bool> deleteResult = _schoolService.Delete(getResult.Data.Id);
		if (!deleteResult.Success) TempData["Failed"] = deleteResult.ErrorMessage;
		else TempData["Success"] = "Başarılı.";
		return RedirectToAction(nameof(List));
	}
